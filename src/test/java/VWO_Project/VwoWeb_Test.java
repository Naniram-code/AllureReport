...
public class VwoWeb_Test {
    ...
    public void VwoAssignment() throws InterruptedException {
        ...
        Thread.sleep(5000);
       WebElement ss=driver.findElement(By.xpath("(//img[@alt='vwo1 bwo2'])[2]"));
        actions.moveToElement(ss).click().build().perform();

         WebElement sss=driver.findElement(By.xpath("//*[@class='menu-content js-menu-content open']/menu-content/ul/li[2]"));
